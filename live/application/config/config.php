...
|
*/
$config['encryption_key'] = 'oqe5238eqdh62329293y8623ei2vdc8v3';
...
$config['csrf_token_name'] = 'csrf_live';//'csrf_test_name';
$config['csrf_cookie_name'] = 'csrf_cookie_live';//'csrf_cookie_name';
