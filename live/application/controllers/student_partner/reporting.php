...
class Reporting extends MY_Site_Controller {
    ...
    public function index() {
        ...
        $this->template->content->view('default/contents/student_partner/reporting/reporting', $vars);
    ...
    public function export_rpt(){
        ...
        $this->load->view('default/contents/student_partner/reporting/export_rpt', $vars);
    }
    ...
    public function export_ses(){
        ...
        $this->load->view('default/contents/student_partner/reporting/export_ses', $vars);
    }
