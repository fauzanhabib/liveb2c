...
class manage_partner_admin extends MY_Site_Controller {
    ...
    public function __construct() {
        ...
        if (!$this->auth_manager->role() || $this->auth_manager->role() != 'ADM' && $this->auth_manager->role() != 'RAD') {
    ...
    public function edit($partner_id='', $user_id=''){
        ...
        if(!$partner || !$data){
            ...
            redirect('admin/manage_partner/list_partner_member/'.$partner_id);
        }
        ...
        $this->template->content->view('default/contents/admin/manage_partner_admin/form', $vars);
        $this->template->publish();
    }
