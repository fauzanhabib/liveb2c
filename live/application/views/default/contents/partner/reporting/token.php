...
<div class="box clearfix">
    <div class="heading pure-g padding-t-30">
        <div class="left-list-tabs pure-menu pure-menu-horizontal text-center margin0">
            <ul class="pure-menu-list">
                <li class="pure-menu-item pure-menu-selected text-center width250 no-hover"><a href="<?php echo site_url('partner/reporting'); ?>" class="pure-menu-link padding-t-b-5 font-16 padding-lr-0 font-light text-cl-lightGrey">Coach Late</a></li>
                <li class="pure-menu-item pure-menu-selected text-center width250 no-hover"><a href="<?php echo site_url('partner/reporting/coach_token'); ?>" class="pure-menu-link padding-t-b-5 font-16 padding-lr-0 font-light text-cl-lightGrey active-tabs-blue">Coach Token</a></li>
    ...
    <div class="content pure-g">
        <div class="margin0 padding15 pure-u-1">
            ...
            <?php 
            echo form_open('partner/reporting/search_token/', 'class="pure-form filter-form" style="border:none"'); 
            ?>
            <div class="pure-g">
