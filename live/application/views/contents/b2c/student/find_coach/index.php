                ...
                <div class="dashboard">
                    ...
                    <div class="dashboard__menu">
                        <div class="booking">
                            ...
                            <span class="activetitle">Book a coach</span>
                        </div>
                        <div class="sessions">
                            <i class="notactive"><?php echo count($datasession); ?></i>
                            <svg width="54px" height="63px" viewBox="0 0 54 63" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <g id="WebView-NeoLive" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="9.Dashboard" transform="translate(-594.000000, -188.000000)" stroke="#606983" stroke-width="2">
                                        <g id="Group-2" transform="translate(330.000000, 158.000000)">
                            ...
                            <span class="notactive"><a href="<?php echo site_url('b2c/student/dashboard'); ?>">Sessions</a></span>
                        </div>
                        <div class="tokens">
                            ...
                            <span class="notactive"><a href="<?php echo site_url('b2c/student/token'); ?>">Tokens</a></span>
                        </div>
                        <div class="help">
                                        ...
                                        <g id="Group-2" transform="translate(330.000000, 158.000000)">
                                            <g id="icHelp" transform="translate(664.945601, 32.201352)">
                                                <g id="Group" stroke-width="1" fill-rule="evenodd" transform="translate(3.857143, 0.000000)">
                                                    <rect id="Rectangle-2-Copy" stroke="#606983" stroke-width="2" x="1.64285714" y="1" width="43" height="52.1207762" rx="4"></rect>
                                                    <text id="?" font-family="CeraGR-Medium" font-size="24" font-weight="500" line-spacing="20" fill="#606983">
                                                        <tspan x="18.2857143" y="27">?</tspan>
                                                    </text>
                                                </g>
                                                <path d="M16.0714286,38.5714286 L37.9285714,38.5714286" id="Line" stroke="#606983" stroke-width="2" stroke-linecap="square"></path>
                                                <path d="M16.0714286,45 L37.9285714,45" id="Line-Copy" stroke="#606983" stroke-width="2" stroke-linecap="square"></path>
                                            </g>
                                        </g>
                                    </g>
                                </g>
                            </svg>
                            <span class="notactive"><a href="<?php echo site_url('b2c/student/help'); ?>">Help</a></span>
                        </div>
                    </div>
                    <!-- mobile display -->
                    <div class="dashboard__bookacoachmobile">
                        <div class="boxselect">
                            <select name="town" id="town" onchange="otherTown()">
                                <option class="lt" value="0">Select</option>
                                <option class="lt" value="1">Name</option>
                                <option class="lt" value="2">Date</option>
                                <option class="lt" value="3">Country</option>
                                <option class="lt" value="4">Language</option>
                            </select>
                        </div>
                        <div id="alt1" style="display:none;">
                            <h1>Search The Coach By :</h1>
                            
                            <input type="text" placeholder=" Search Coach...">
                             <div class="btnsearch">
                                <button class="neobutton ">Search Coach</button>
                             </div>
                        </div>
                        ...
                        <div id="alt3" style="display:none;" class="alt3">
                            <h1>Search The Coach By :</h1>
                            <div class="btnsearch">
                                <button class="neobutton ">Search Coach</button>
                             </div>
        ...
        jQuery(function($) {
          $('#town').on('change', function() {
            ...
            if ($(this).val() === "1"){
               ...
               $("#alt2").hide(); $("#alt3").hide(); $("#alt4").hide();
            }
            else if ($(this).val() === "2"){
               $("#alt2").show(this.value == 2);
                $("#alt1").hide(); $("#alt3").hide(); $("#alt4").hide();
            }
            else if ($(this).val() === "3"){
               $("#alt3").show(this.value == 3);
                $("#alt1").hide(); $("#alt2").hide(); $("#alt4").hide();
            }
            else if ($(this).val() === "4"){
               $("#alt4").show(this.value == 4);
                $("#alt1").hide(); $("#alt2").hide(); $("#alt3").hide();
            }
            else if($(this).val() === "0"){
               
                $("#alt1").hide(); $("#alt2").hide(); $("#alt3").hide(); $("#alt4").hide();
            }
          });
        })
    </script>
