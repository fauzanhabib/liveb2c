    ...
    <div class="dashboard">
        ...
        <div class="dashboard__menu">
            <div class="booking">
                ...
                <span><a href="<?php echo site_url('b2c/student/find_coaches/single_date'); ?>">Book a coach</a></span>
            </div>
            <div class="sessions">
            ...
            <div class="tokens">
                ...
                <span><a href="<?php echo site_url('b2c/student/token'); ?>">Tokens</a></span>
            </div>
            <div class="help">
                ...
                <span><a href="<?php echo site_url('b2c/student/help'); ?>">Help</a></span>
            </div>
        </div>
