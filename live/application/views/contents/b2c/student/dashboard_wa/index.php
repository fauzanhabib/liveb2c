...
<script>
    ...
    $("#clearlive").click(function() {
        $.post("<?php echo site_url('b2c/student/dashboard_wa/clear_live');?>", { 'id': userid },function(data) {
...
function update_study(){
  $.ajax({
   type:"POST",
   url:"<?php echo site_url('b2c/student/dashboard_wa/update_studyprog');?>",
        ...
        function update_clock(){
            ...
            if(t.total<=0){
                if (now < end){
                    ...
                    $.get("<?php echo site_url('b2c/student/dashboard_wa/get_id');?>",function(data) {
                        var val_id = data;
                        // console.log(val_id);
